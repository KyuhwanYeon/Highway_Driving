    ...
    if (length && length > 2 && data[0] == '4' && data[1] == '2')
    {
      ...
      if (s != "")
      {
        ...
        if (event == "telemetry")
        {
          ...
          // vector<vector<double>> quintic_trajectory = quintic_polynomial_trajectory_generation(car_x, car_y, car_yaw, car_s, car_d, target_vel, target_lane, end_path_s, end_path_d,
          //                                      previous_path_x,  previous_path_y,  car_speed,
          //                                     map_waypoints_s,  map_waypoints_x,  map_waypoints_y, map_waypoints_dx, map_waypoints_dy, behavior);
